                    ...
                    <form class="needs-validation" novalidate action="EditProfileForm" method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input value="${sessionScope.get("account")==null?"":sessionScope.get("account").getFirstName()}" name="firstName" type="text" class="form-control" id="firstname" placeholder=""  required>
                                <div class="invalid-feedback">
