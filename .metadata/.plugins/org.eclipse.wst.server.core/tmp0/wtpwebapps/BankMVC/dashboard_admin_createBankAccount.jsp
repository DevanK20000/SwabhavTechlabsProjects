...
<main class="d-flex flex-nowrap h-100">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="BankAccountForm" class="nav-link text-white active">
    ...
    <div class="container ">
            <div class="py-5 text-center">
                ...
                <p class="lead">Create new Bank accounts.</p>
            </div>

            <div class="container-fluid d-flex justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <h4 class="mb-3">Bank Account form</h4>

                    <form class="needs-validation" novalidate action="ValidateCustomerId" method="post">
                        <div class="row g-3">
                            <div class="col-md-8">
                                <label for="CustomerID" class="form-label">Customer ID</label>
                                <div class="input-group has-validation">
                                    <span class="input-group-text">@</span>
                                    <input  value="${requestScope.get("customerId")==null?"":requestScope.get("customerId")}" name="customerId" type="number" class="form-control" id="CustomerID" placeholder="Customer" required
                                    <c:if test="${disableFormCustomerId}">
                                           disabled
                                    </c:if>>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                <button class="btn btn-primary" type="submit"  <c:if test="${disableFormCustomerId}">
                                    disabled
                    ...
                    <form class="needs-validation" novalidate action="CreateBankAccount" method="post">
                        <div class="row g-3">
                            <input type="number" name="customerId" value="${requestScope.get("customerId")==null?"":requestScope.get("customerId")}" hidden>
                            <div class="col-sm-8">
                                <label for="username" class="form-label">Username</label>
                                <div class="input-group has-validation">
                                    <span class="input-group-text">@</span>
                                    <input value="${requestScope.get("username")==null?"":requestScope.get("username")}" name="username" type="text" class="form-control" id="username" placeholder="Username" required disabled>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="bankAccountType" class="form-select" id="accountType" required  <c:if test="${disableForm}">
                                    disabled
                                </c:if>>
                                    <option value="${BankAccountType.saving.name()}">Savings</option>
                                    <option value="${BankAccountType.current.name()}">Current</option>
                                </select>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input value="${requestScope.get("firstName")==null?"":requestScope.get("firstName")}" name="firstName" type="text" class="form-control" id="firstname" placeholder=""  required disabled>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input value="${requestScope.get("lastName")==null?"":requestScope.get("lastName")}" name="lastName" type="text" class="form-control" id="lastName" placeholder="" required  disabled>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input value="${requestScope.get("email")==null?"":requestScope.get("email")}" name="email" type="email" class="form-control" id="email" placeholder="you@example.com"  disabled>
                                <div class="invalid-feedback">
                        ...
                        <button class="w-100 btn btn-primary btn-lg" type="submit"  <c:if test="${disableForm}">
                            disabled
                        </c:if>>Create Bank Account</button>
                    </form>
                </div>
            </div>
