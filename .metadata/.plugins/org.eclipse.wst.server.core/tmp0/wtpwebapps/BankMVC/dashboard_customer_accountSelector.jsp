...
<main class="d-flex flex-nowrap h-100">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <a href="BankAccountSelector" class="nav-link text-white active">
    ...
    <div class="container ">
            <div class="py-5 text-center">
                ...
                <p class="lead">Select accounts from the list.</p>
            </div>

            <div class="container-fluid d-flex justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <h4 class="mb-3">Accounts</h4>
                    <form class="needs-validation" id="loginForm" novalidate action="SelectAccount" method="post">
                        <div class="row g-3">

                            <div class="col-12">
                                <label for="accounts" class="form-label">Accounts</label>
                                <select name="accountSelected" class="form-select" id="accounts" required>
                                    <c:set value="${requestScope.get('bankAccounts')}" var="bankAccounts" scope="session"/>
                                    <c:forEach items="${bankAccounts}" var="bankAccount">
                                        <option value="${bankAccount.getAccountNumber()}"><c:out value="Account Number:${bankAccount.getAccountNumber()} Balance:${bankAccount.getBalance()}"/></option>
                                    </c:forEach>
                                </select>
                        ...
                        <hr class="my-4">
                        <button class="w-100 btn btn-primary btn-lg" type="submit">Select Account</button>
                        <hr class="my-4">
