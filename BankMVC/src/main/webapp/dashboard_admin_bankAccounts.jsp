...
<%@ page import="com.aurionpro.bankmvc.entity.Customer" %>
<%
...
<main class="d-flex flex-nowrap h-100">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="BankAccountList" class="nav-link text-white active">
    ...
    <div class="container ">
            <div class="py-5 text-center">
                <h2>Bank Accounts</h2>
                <p class="lead">View, Search, Bank Accounts.</p>
            </div>
            ...
            <div class="container-fluid d-flex justify-content-center">
                <table id="customer_table" class="display nowrap" style="width:100%">
                    ...
                    <tr>
                        ...
                        <th>Account Type</th>
                        <th>balance</th>
                        <th>Minimum balance/Overdue limit</th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:set var="bankAccounts" scope="session" value="${requestScope.get('bankAccounts')}"/>
                    <c:forEach items="${bankAccounts}" var="bankAccount">
                        <tr>
                            <td><c:out value="${bankAccount.getAccountNumber()}"/></td>
                            <td><c:out value="${bankAccount.getCustomerId()}"/></td>
                            <td><c:out value="${bankAccount.getBankAccountType().name()}"/></td>
                            <td><c:out value="${bankAccount.getBalance()}"/></td>
                            <td><c:out value="${bankAccount.getMin_overdue_limit()}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                    <tfoot>
