...
<main class="d-flex flex-nowrap h-100">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="CustomerList" class="nav-link text-white active">
    ...
    <div class="container ">
            <div class="py-5 text-center">
                <h2>Customers</h2>
                <p class="lead">View, Search, Filter Customer.</p>
            </div>
            ...
            <div class="container-fluid d-flex justify-content-center">
                <table id="customer_table" class="display" style="width:100%">
                    ...
                    <tbody>
                    <c:set var="customers" scope="session" value="${requestScope.get('customers')}"/>
                    <c:forEach items="${customers}" var="customer">
                        <tr>
                            <td><c:out value="${customer.getCustomerId()}"/></td>
                            <td><c:out value="${customer.getLoginId()}"/></td>
